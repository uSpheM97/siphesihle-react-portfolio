    ...
    const data = [
        {
            ...
            description: 'C#, Flutter, HTML, CSS ,JavaScript React Js',
        },
        {
            name: 'Education',
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    <img src='./assets/user-image.jpg' alt="" className="w-64 sm:w-80 rounded-3xl max-w-none" />
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">I am a Full-Stack Developer with 4 years of experience developing modern web applications and 4 months of professional industry experience. I build secure, scalable systems using frontend and backend technologies, powered by Microsoft Azure. I am Azure Certified (AZ-900, AZ-204) and passionate about delivering impactful digital solutions.</p>
